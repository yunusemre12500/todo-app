module github.com/yunusemre12500/todo-app/repository/user/mongo
...
require (
	...
	github.com/yunusemre12500/todo-app/repository/user v1.0.0
...
replace (
	...
	github.com/yunusemre12500/todo-app/repository/user => ../../user
)
